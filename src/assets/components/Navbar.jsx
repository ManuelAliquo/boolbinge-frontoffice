      ...
      <div className="container-fluid">
        ...
        <ul className="list-unstyled m-0 d-flex flex-grow-1 justify-content-evenly align-items-center">
          <li className="nav-item">
            <Link className="nav-link d-flex flex-column align-items-center p-0" to="#">
        ...
        {/* search */}
        <form className="nav-search d-flex d-none d-sm-flex" role="search">
        ...
        <div className="d-sm-none">
          ...
          {isSearchOpen && (
            <div className="position-absolute end-0 mt-3 p-2 bg-dark rounded-4">
